...
<body>
  ...
  <form name="frmsearch" method="post" action="staffsearch.php">
    <table align="center" >
      <tr>
        <td>
    ...
    $data=$con->query("select staffid,name,designation,education,workexperience,mobilenumber,password,emailid from userstaffregister where staffid='$search' or name='$search' ");
